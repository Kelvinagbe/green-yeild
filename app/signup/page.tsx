                    ...
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        ...
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${
                          strength >= i ? (strengthMeta[strength]?.color ?? 'bg-green-500') : 'bg-white/10'
                        }`}
                      />
                    ))}
                  </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative mt-0.5 shrink-0">
                ...
                <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition ${
                  form.agreed ? 'bg-green-600 border-green-600' : 'border-white/20 bg-white/[0.04] group-hover:border-green-600/40'
                }`}>
                  {form.agreed && (
              ...
              <span className="text-sm text-zinc-500 leading-relaxed">
                ...
                <Link href="/terms" className="text-green-500 font-medium hover:text-green-400 transition">Terms of Service</Link>
                {' '}and{' '}
                <Link href="/privacy" className="text-green-500 font-medium hover:text-green-400 transition">Privacy Policy</Link>
              </span>
            </label>
